...
import { ListTrainingRequestComponent } from './pages/list-training-request/list-training-request.component';
...
@NgModule({
  ...
  providers: [AuthService,UserService,TrainingRequestService,DatePipe],
